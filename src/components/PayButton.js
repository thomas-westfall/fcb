...
export default class PayButton extends React.Component {
    render() {
        const onSuccess = async (payment) => {
            // Congratulation, it came here means everything's fine!
                    ...
                    await axios({
                      ...
                      await axios({
                        method: 'put',
                        url: 'https://cors-anywhere.herokuapp.com/https://vpay-backend-auth.herokuapp.com/api/cards/'+this.props.id,
                        data: {
                          username: this.props.username,
                          paid: true
                        }
        ...
        // In card to get production's app-ID, you will have to send your app to Paypal for approval first
